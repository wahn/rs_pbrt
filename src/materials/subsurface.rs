...
pub struct SubsurfaceMaterial {
    ...
    pub u_roughness: Arc<Texture<Float> + Sync + Send>, // default: 
    pub v_roughness: Arc<Texture<Float> + Sync + Send>, // default: 
...
impl SubsurfaceMaterial {
    ...
    pub fn create(mp: &mut TextureParams) -> Arc<Material + Send + Sync> {
        ...
        let sig_a: Spectrum = Spectrum::from_rgb(&sig_a_rgb);
        let sig_s: Spectrum = Spectrum::from_rgb(&sig_s_rgb);
        ...
        Arc::new(SubsurfaceMaterial::new(scale, kr, kt, sigma_a, sigma_s, g, eta,
                                         roughu, roughv, bump_map, remap_roughness))
    }
