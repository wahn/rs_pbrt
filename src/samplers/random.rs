...
impl RandomSampler {
    ...
    pub fn clone_with_seed(&self, seed: u64) -> Box<Sampler> {
        ...
        random_sampler.samples_1d_array_sizes = self.samples_1d_array_sizes.to_vec();
        random_sampler.samples_2d_array_sizes = self.samples_2d_array_sizes.to_vec();
        random_sampler.sample_array_1d = self.sample_array_1d.to_vec();
        random_sampler.sample_array_2d = self.sample_array_2d.to_vec();
